...
describe('ProductsService', () => {
  ...
  it('should test get list products', () => {
    service.getProductsList().subscribe(productsList => {
      expect(productsList.products.length).toEqual(2);
      expect(productsList.products[0].id).toEqual("EJf7MU4hES59rlLMJrdH");
    })
